...
function updateLatest(reading) {
  ...
  document.getElementById("temperature").textContent = formatNumber(values.temperature, 2);
  document.getElementById("humidity").textContent = formatNumber(values.humidity, 2);
